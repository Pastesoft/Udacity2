...
def link_by_id(link_id):
  return link_index.get(link_id) #we use get method to manage requests to an unknown link

print link_by_id(4)
print link_by_id(50) # error without the get, none returned if we use get
print link_by_id(1)
